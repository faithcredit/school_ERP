...
@section('content')
                ...
                <div class="row">
                    <div class="col-md-6 offset-md-3">
                        <div class="row">
                            <div class="col-md-10">
                                <div class="form-group row">
                                    <label for="year" class="col-lg-3 col-form-label font-weight-bold">Select Year <span class="text-danger">*</span></label>
                                    <div class='col-lg-9'>
                        ...
                        <div class='row'>
                            <div class="col-md-10">
                                <div class="form-group row">
                                    <label for="month" class="col-lg-3 col-form-label font-weight-bold">Month <span class="text-danger">*</span></label>
                                    <div class='col-lg-9'>
                                        <select data-placeholder="Select Month" required id="month" name="month" class="form-control select">
                                            @for($m=1; $m<13; $m++)
    ...
    <div class="card">
        <div class="card-header header-elements-inline">
            <h6 class="card-title">Manage Payments for {{ $year }} Session / {{$month}}</h6>
            {!! Qs::getPanelOptions() !!}
        </div>
