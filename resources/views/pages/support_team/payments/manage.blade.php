                ...
                <div class="row">
                    <div class="col-md-6 offset-md-3">
                        <div class="row">
                            <div class="col-md-10">
                              <div class="form-group row">
                                  <label for="my_class_id" class="col-lg-3 col-form-label font-weight-bold">Class:</label>
                                  <div class='col-lg-9'>
                        ...
                        <div class="row">
                            <div class='col-md-10'>
                                <div class="form-group row">
                                <label for="method" class="col-lg-3 col-form-label font-weight-semibold">Month</label>
                                <div class="col-lg-9">
                                    <select class="form-control select" name="month" id="month">
                                        @for($m=1; $m<=12; $m++)
                                            <option {{ $m == $month ? 'selected':'' }} value={{$m}}>{{$m}}</option>
                                        @endfor
                                    </select>
                                </div>
                        </div>
                            ...
                            <div class="col-md-2">
                                <div class="text-right">
                                    <button type="submit" class="btn btn-primary">Submit <i class="icon-paperplane"></i></button>
                                </div>
                            </div>
                        </div>
                    </div>
