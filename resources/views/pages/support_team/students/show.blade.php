                    ...
                    <div class="tab-pane fade show active" id="basic-info">
                        <table class="table table-bordered">
                            ...
                            <tr>
                             ...
                             <tr>
                                <td class="font-weight-bold">Roll Num</td>
                                <td>{{ $sr->roll_num }}</td>
                            </tr>
                            @if($sr->my_parent_id)
                                <tr>
                                    ...
                                    <td>
                                        <span><a target="_blank" href="{{ route('users.show', Qs::hash($sr->my_parent_id)) }}">{{ $sr->my_parent->name }} @if($sr->my_parent->mother_name) {{ $sr->my_parent->mother_name }} @endif</a></span>
                                    </td>
