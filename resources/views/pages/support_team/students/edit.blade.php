...
@section('content')
        ...
        <div class="card">
            ...
            <form id="ajax-edit" method="post" enctype="multipart/form-data" class="ajax-update p-3" data-reload="#ajax-title" 
                            ...
                            <div class="form-group">
                                ...
                                <select data-placeholder="Choose..."  name="my_parent_id" id="my_parent_id" class="select-search form-control">
                                    ...
                                    @foreach($parents as $p)
                                        <option {{ (Qs::hash($sr->parent_id) == Qs::hash($p->id)) ? 'selected' : '' }} value="{{ $p->id }}">{{ $p->name }}</option>
                                    @endforeach
                                </select>
                            </div>
                        </div>
...
@endsection
@section('scripts')
<script src="{{ asset('assets/js/pages/super_team/students/edit.js') }}"></script>
@endsection 