...
class PaymentRepo
{
    ...
    public function getAllMyPR($st_id, $month = NULL, $year = NULL)
    {
        return $year ? $this->getRecord(['student_id' => $st_id, 'month' => $month, 'year' => $year]) : $this->getRecord(['student_id' => $st_id]);
    }

    public function getRecord($data, $order = 'month', $dir = 'desc')
    {
